module.exports = function(grunt) {
  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'simplediagrams_sphinx_theme/static/fonts/',
              filter: 'isFile'
          },
          {
              expand: true,
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'sass',
          src: ['*.sass'],
          dest: 'simplediagrams_sphinx_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    browserify: {
      dev: {
        options: {
          external: ['jquery'],
          alias: {
            'simplediagrams-sphinx-theme': './js/theme.js'
          }
        },
        src: ['js/*.js'],
        dest: 'simplediagrams_sphinx_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    clean: {
      ...
      fonts: ["simplediagrams_sphinx_theme/static/fonts"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['simplediagrams_sphinx_theme/**/*', 'demo_docs/**/*.rst', 'demo_docs/**/*.py'],
